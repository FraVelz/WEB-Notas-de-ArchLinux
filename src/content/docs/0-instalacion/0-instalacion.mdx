...
description: Guía para instalar Arch Linux - ISO, USB booteable, VirtualBox y archinstall
---
...
:::note
Este no es un manual de instalación detallado. Puede haber variaciones según tu computadora o configuración. Usa esta guía como referencia general y asegúrate de investigar los comandos o pasos específicos que correspondan a tu dispositivo.
