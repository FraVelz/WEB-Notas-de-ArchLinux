...
description: Flameshot para capturas en Arch Linux
---

**Flameshot** es una herramienta de captura de pantalla **muy popular en Linux**, que combina **simplicidad** con **funciones avanzadas de edición** antes de guardar la imagen.
...
Para Hyprland o cualquier WM:

* `PrtSc` → `flameshot gui`
* `Shift + PrtSc` → seleccionar área específica
* Copiar al portapapeles: `flameshot full -c`
